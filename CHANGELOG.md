...
## [v3.0.0](https://github.com/ChumsInc/chums-local-modules/compare/v2.3.6...v3.0.0)

## [v2.3.6](https://github.com/ChumsInc/chums-local-modules/compare/v2.3.5...v2.3.6) - 2026-09-11

### Commits

- chore: update dependencies and peer dependencies in `package-lock.json` and `package.json`

- Updated various package versions to their latest releases.
- Moved `xlsx` from `dependencies` to `peerDependencies`. [`27a208c`](https://github.com/ChumsInc/chums-local-modules/commit/27a208ccef2808f6983eb25524fef7587821d1b5)
- chore: update dependencies to latest versions in `package-lock.json` [`911eb4b`](https://github.com/ChumsInc/chums-local-modules/commit/911eb4b0fd30c9d76b92662631ac7920020cf254)
- feat: add handlers for fixing API usage paths and parameters

- Introduced `fix-handlers.ts` with functions to load and update API usage fixes.
- Added SQL queries to identify and correct invalid paths and parameters.
- Included a test script `test-fix.ts` for verification. [`729464f`](https://github.com/ChumsInc/chums-local-modules/commit/729464fa1b958aa5107a98cd6e68d6edd30af6f0)
- feat: add utilities for fixing API usage paths and parameters

- Introduced `fix-handlers.js` and `fix-handlers.d.ts` for loading and updating API usage fixes.
- Added SQL queries to identify and update incorrect API paths and parameters.
- Implemented `loadAPIFixData` and `updateAPIUsage` functions for processing fixes.
- Included test script `test-fix.js` for verification purposes. [`fa82495`](https://github.com/ChumsInc/chums-local-modules/commit/fa82495f35e78e5ceb9afc19a3517a08237d125c)
- fix: move API usage logging to `res.on('finish')` for accurate response handling

- Updated middleware to defer logging until the response has finished.
- Adjusted `path` to include `req.baseUrl` for improved accuracy. [`732e8fd`](https://github.com/ChumsInc/chums-local-modules/commit/732e8fdf4f740dc3bf744df611c87f3c344715f8)
- refactor: improve API usage logging for better parameter handling

- Combined `req.params` and `req.query` for consistent parameter processing.
- Updated `path` and `params` assignment logic for clarity and accuracy.
- Adjusted TypeScript declarations and compiled output to align with changes. [`c627777`](https://github.com/ChumsInc/chums-local-modules/commit/c62777712451d6c43704e47445ed9e5d7999eff6)
- fix: fallback to `req.path` when `req.route.path` is undefined in API usage logging [`76e9793`](https://github.com/ChumsInc/chums-local-modules/commit/76e979386370486a988f759397e6dc3fe6e4ca00)
- chore: move `chums-types` to `devDependencies` in `package-lock.json` and `package.json` [`0fce33d`](https://github.com/ChumsInc/chums-local-modules/commit/0fce33de215c5871c5fb5ac4a2c2d556122b4465)
- fix: handle undefined `req.route.path` in API usage logging

- Updated `path` assignment to gracefully handle cases where `req.route.path` is undefined.
- Adjusted TypeScript declarations and compiled output to reflect changes. [`6a871f4`](https://github.com/ChumsInc/chums-local-modules/commit/6a871f4709b5640abedd9fc798220023db70381a)
- chore: add `chums-types` to `peerDependencies` in `package.json` and `package-lock.json` [`52dcb12`](https://github.com/ChumsInc/chums-local-modules/commit/52dcb12addffb865e9523e4c5679557b9366776e)

## [v2.3.5](https://github.com/ChumsInc/chums-local-modules/compare/v2.3.4...v2.3.5) - 2026-07-21

### Commits

- refactor: convert `logAPIUsageMiddleware` to named function for improved clarity and consistency

- Updated middleware implementation from an arrow function to a named function.
- Adjusted TypeScript declarations and compiled outputs to match changes. [`2b141ea`](https://github.com/ChumsInc/chums-local-modules/commit/2b141eaff5673b96b507e3215df2ff36de1c11a3)
- feat: extend API usage logging with `api` field and middleware factory

- Added an `api` field to `LogApiUsageProps` and updated logging logic accordingly.
- Refactored `logAPIUsageMiddleware` into a factory function to allow per-API customization.
- Updated TypeScript declarations and compiled output to reflect these changes. [`c6b794b`](https://github.com/ChumsInc/chums-local-modules/commit/c6b794b220f9578d2019883a5075b17d2045a731)
- fix: enhance cookie consent handling and MySQL configuration

- Added `isCookieConsentJSONRow` type guard to distinguish JSON-based rows.
- Extended cookie consent logic to support `CookieConsentJSONRow`.
- Updated MySQL configuration with `jsonStrings` option controlled by environment variables. [`71342a5`](https://github.com/ChumsInc/chums-local-modules/commit/71342a598462f77280e616964af32d379f3b2cf9)

## [v2.3.4](https://github.com/ChumsInc/chums-local-modules/compare/v2.3.3...v2.3.4) - 2026-07-20

### Commits

- chore: npm updates [`2497b05`](https://github.com/ChumsInc/chums-local-modules/commit/2497b051373bf39ca414f8af905f0d51b0f84b6b)
- feat: add API usage logging middleware and improve cookie parsing

- Introduced `logApiUsage` and `logAPIUsageMiddleware` for tracking API usage.
- Enhanced cookie parsing by replacing `cookie.parse` with `cookie.parseCookie`.
- Exported new logging utilities for broader use. [`31ddfab`](https://github.com/ChumsInc/chums-local-modules/commit/31ddfab038983f1944981d6d74f6ae129c1deef0)
- chore: build project [`5fd4639`](https://github.com/ChumsInc/chums-local-modules/commit/5fd463949f0be99e714dcbe12795fa39db64e50e)

## [v2.3.3](https://github.com/ChumsInc/chums-local-modules/compare/v2.3.2...v2.3.3) - 2026-06-24

### Commits

- build: update dependencies

- Updated `@types/node` to v26.0.0 and `nodemailer` to v9.0.1.
- Incremented various @typescript-eslint packages to v8.61.1.
- Upgraded additional dependencies such as `body-parser`, `semver`, and others for improved compatibility. [`23ae4df`](https://github.com/ChumsInc/chums-local-modules/commit/23ae4df549066d667993a956898c8d650e1069f9)

## [v2.3.2](https://github.com/ChumsInc/chums-local-modules/compare/v2.3.1...v2.3.2) - 2026-06-15

### Commits

- feat: enhance MySQL utilities with configurable options and update dependencies

- Added `getPool` utility for creating MySQL connection pools with custom options.
- Refactored MySQL configuration for better modularity between connection and pool options.
- Updated several dependencies, including TypeScript and @types/nodemailer. [`ca11ce6`](https://github.com/ChumsInc/chums-local-modules/commit/ca11ce67baec4f683230f1822056e57dc230e41c)

## [v2.3.1](https://github.com/ChumsInc/chums-local-modules/compare/v2.3.0...v2.3.1) - 2026-04-03

### Commits

- fix: add alternate referrer spellings for access log [`d59eb4b`](https://github.com/ChumsInc/chums-local-modules/commit/d59eb4bb2b211aea448212c13b9505cc377ebcd4)
- chore: npm udpates [`dc09c9c`](https://github.com/ChumsInc/chums-local-modules/commit/dc09c9c3778d87bd2439959ae3ffcbd44a16b692)
- feat: add user validation type guards (isValidatedApiUser, isValidatedUser, isUserValidation) to validate-user utilities [`18b1584`](https://github.com/ChumsInc/chums-local-modules/commit/18b1584c65b46835dd8c8dc504a202e7d2c69ccf)
- fix: typo corrections and type adjustments in named-placeholders and api-fetch [`d49cc0b`](https://github.com/ChumsInc/chums-local-modules/commit/d49cc0bc66f5e90a621bf932fad5999dbe01f1e4)
- fix: update validation API endpoint to use /api/user/v2/validate.json [`96a72a0`](https://github.com/ChumsInc/chums-local-modules/commit/96a72a07ada56c3b8e3bdeb1b7b31aea76448d0e)
- build: update API [`6f30361`](https://github.com/ChumsInc/chums-local-modules/commit/6f3036159e855fd5ccfcb3c409a65c1356adede5)
- fix: make ColumnNames properties optional in toXLSX types [`c21bf6b`](https://github.com/ChumsInc/chums-local-modules/commit/c21bf6b5f16ed5d373a087cde9266a19e94523e6)
- try the incorrectly spelled referrer header name 'referer' for nginx access log [`471a34f`](https://github.com/ChumsInc/chums-local-modules/commit/471a34f5a3429af264df5c025194583d88d1ffc6)

## [v2.3.0](https://github.com/ChumsInc/chums-local-modules/compare/v2.2.5...v2.3.0) - 2026-02-19

### Commits

- chore: update npm dependencies [`d611e68`](https://github.com/ChumsInc/chums-local-modules/commit/d611e68bca8ebd5389dbddafb06ee215c265725f)
- fix: update user account validation logic to use v2 API endpoints and simplify URL construction [`beb8a6c`](https://github.com/ChumsInc/chums-local-modules/commit/beb8a6c883e54b3ddbf809656f0dc2d37a1aff60)
- chore: code cleanup [`47d2076`](https://github.com/ChumsInc/chums-local-modules/commit/47d20765f8c03d10050aaac0bfab3a0c966dc1ff)
- chore: code cleanup [`9003755`](https://github.com/ChumsInc/chums-local-modules/commit/900375569c0fce5db69be649e7391c9aaba02f6b)

## [v2.2.5](https://github.com/ChumsInc/chums-local-modules/compare/v2.2.4...v2.2.5) - 2026-01-23

### Commits

- chore: update npm dependencies and update tsconfig to use verbatimModuleSyntax [`60e31d5`](https://github.com/ChumsInc/chums-local-modules/commit/60e31d57c6de197f866350245c2a9f150214ef10)
- chore: update npm dependencies [`e832072`](https://github.com/ChumsInc/chums-local-modules/commit/e832072c1d3d409d8572111f9de8752d644d7278)
- chore: update npm dependencies [`0040ca5`](https://github.com/ChumsInc/chums-local-modules/commit/0040ca5933e27bb600ec3f6965e565bc52fc122a)
- chore:npm udpates [`0294944`](https://github.com/ChumsInc/chums-local-modules/commit/02949440bfdce1cabad17f06f59a42a5bad66081)

## [v2.2.4](https://github.com/ChumsInc/chums-local-modules/compare/v2.2.3...v2.2.4) - 2025-10-16

### Commits

- chore:npm updates [`6831b51`](https://github.com/ChumsInc/chums-local-modules/commit/6831b515d0fc7f077e6f4b6b3fc58785c40a9fc8)
- chore:npm updates [`8d16318`](https://github.com/ChumsInc/chums-local-modules/commit/8d163186063b2c88293a283807e1197af5cde75f)

## [v2.2.3](https://github.com/ChumsInc/chums-local-modules/compare/v2.2.2...v2.2.3) - 2025-09-24

### Commits

- fix: include gpc prop in CookieConsentRecord [`91f4735`](https://github.com/ChumsInc/chums-local-modules/commit/91f47350bb4ca044f5bd7144589ffddc5eb69f96)

## [v2.2.2](https://github.com/ChumsInc/chums-local-modules/compare/v2.2.1...v2.2.2) - 2025-09-24

### Commits

- cleanup user validation for use with cookie-consent options. [`7f00e72`](https://github.com/ChumsInc/chums-local-modules/commit/7f00e7259140365e208a1c1779d1240940a27a6d)

## [v2.2.1](https://github.com/ChumsInc/chums-local-modules/compare/v2.2.0...v2.2.1) - 2025-09-22

### Commits

- cleanup user validation for use with cookie-consent options. [`51f8b08`](https://github.com/ChumsInc/chums-local-modules/commit/51f8b0808eeadba7479a15367e7ccc8138058379)

## [v2.2.0](https://github.com/ChumsInc/chums-local-modules/compare/v2.1.10...v2.2.0) - 2025-09-19

### Commits

- feat: add cookie-consent handlers [`6df58c4`](https://github.com/ChumsInc/chums-local-modules/commit/6df58c41a95154ff3a84ee1655523412bd8780f5)
- fix: migrate ValidatedUser to ChumsInc/chums-types repository [`7462be3`](https://github.com/ChumsInc/chums-local-modules/commit/7462be33eb349f914a0f34b1a04b5e73f77b4c33)

## [v2.1.10](https://github.com/ChumsInc/chums-local-modules/compare/v2.1.9...v2.1.10) - 2025-07-28

### Commits

- fix: buildXLSXHeaders now returns Headers [`cd5a12d`](https://github.com/ChumsInc/chums-local-modules/commit/cd5a12dab51de9ada20a496bc42b88a9d1e797e2)

## [v2.1.9](https://github.com/ChumsInc/chums-local-modules/compare/v2.1.8...v2.1.9) - 2025-07-28
...
- fix: I broke a fucking endpoint for user validation... fixing it. [`70e50d4`](https://github.com/ChumsInc/chums-local-modules/commit/70e50d4cd5be3066fc110d6e48abef390c272a40)
...
## [v2.1.0](https://github.com/ChumsInc/chums-local-modules/compare/v2.0.9...v2.1.0) - 2024-10-01
...
- chore: npm updates to fix vulnerability in mysql2 &lt; 3.9.7 [`050ef39`](https://github.com/ChumsInc/chums-local-modules/commit/050ef399089050f92944c0f36b227b6d76d1de61)
